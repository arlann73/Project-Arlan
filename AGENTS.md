...
* Basically just SOPs written in `directives/`
...
* Example: you hit an API rate limit → you then look into the API → find a batch endpoint that would fix → rewrite the script to accommodate → test → update the directive.
